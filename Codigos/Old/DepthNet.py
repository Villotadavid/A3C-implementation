...
import sys
#sys.path.append('C:/Users/usuario/Desktop/Doctorado/Depth perception/Exial/models/syncbn')
...
class Decoder(nn.Module):
    def __init__(self, inchannels = [256, 512, 1024, 2048], midchannels = [256, 256, 256, 512], upfactors = [2,2,2,2], outchannels = 1):
        ...
        self.outconv = AO(inchannels=int(self.inchannels[0]), outchannels=self.outchannels, upfactor=2)
