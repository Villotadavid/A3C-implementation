...
def main():
    ...
    shared_params = async_.share_params_as_shared_arrays(model)
    shared_states = async_.share_states_as_shared_arrays(opt)
    ...
    def run_func(process_idx):
        ...
        model, opt = model_opt()
        async_.set_shared_params(model, shared_params)
        async_.set_shared_states(opt, shared_states)
    ...
    async_.run_async(args.processes, run_func)
