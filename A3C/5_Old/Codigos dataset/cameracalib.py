...
workingFolder   = "/home/tev/Desktop/imggood"
imageType       = 'jpg'
#------------------------------------------
...
if (nPatternFound > 1):
    ...
    general='/home/tev/Desktop/imggood'
	...
	n=n+1
        print("ROI: ", x, y, w, h)
        cv2.imwrite('/home/tev/Desktop/imR/calibresult'+str(n)+'.png',dst)
    ...
    cv2.imwrite("/home/pi/Desktop/how_do_drone/opencv/imagenes/Calibradas/calibresult.png",dst)
